...
function navigate(page) {
    ...
    if (page === 'minha_performance') loadMinhaPerformance();
    if (page === 'premiacao_admin') loadPremiacaoAdmin();
    if (page === 'marco_email') loadMarcoEmail();
