...
function navigate(page, params) {
    ...
    if (page === 'subir_blog' && typeof sbLoadPage === 'function') sbLoadPage();
    if (page === 'tracker_tarefas' && typeof loadTrackerTarefas === 'function') loadTrackerTarefas();
