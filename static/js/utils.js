...
const SIDEBAR_GROUPS = {
    ...
    comercial: ['dist_consultor', 'pipeline', 'update', 'match_merge', 'comercial_rgm', 'inscricao', 'auditoria_comercial', 'leads_parados'],
};
