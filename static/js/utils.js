...
function navigate(page, params) {
    ...
    if (page === 'relatorio_veteranos' && typeof relatorioVeteranosLoadPage === 'function') relatorioVeteranosLoadPage();
