...
const SIDEBAR_GROUPS = {
    ...
    comercial: ['pipeline', 'update', 'match_merge', 'comercial_rgm', 'inscricao', 'auditoria_comercial', 'leads_parados', 'minha_performance', 'repasse'],
